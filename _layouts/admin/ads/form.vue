           ...
           <div class="row">
             <div class="col-12">
               <q-card-section class="q-pa-xl form-general">
                 ...
                 <div class="text-h5 text-primary q-mb-xs font-family-secondary capitalize">{{$tr('qad.sidebar.admin.ads')}}</div>
      ...
      methods: {
        ...
        getServices() {
          ...
          this.$crud.index("apiRoutes.qad.services",params).then(response => {
            ...
            for(var i=0;i<response.data.length;i++){
              this.serviceOptions.push({label:response.data[i].title,value:response.data[i].id,id:response.data[i].id});
            }
          });
        },
        // Get categories
        getCategories() {
          ...
          this.$crud.index("apiRoutes.qad.categories",params).then(response => {
            ...
            for(var i=0;i<response.data.length;i++){
              this.categoryOptions.push({label:response.data[i].title,value:response.data[i].id,id:response.data[i].id});
            }
          });
        },
        getProvinces() {
